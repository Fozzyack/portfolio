...
export function HeroSection() {
    return (
        <section id="home" className="relative overflow-hidden min-h-screen">
            ...
            <div className="absolute -left-24 top-20 -z-10 h-72 w-72 rounded-full bg-primary/20 blur-3xl md:h-96 md:w-96" aria-hidden />
            <div className="absolute -right-32 bottom-0 -z-10 h-80 w-80 rounded-full bg-accent/20 blur-3xl md:h-[28rem] md:w-[28rem]" aria-hidden />
                ...
                <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
                    <div className="space-y-10">
                        ...
                        <p className="max-w-2xl text-lg text-foreground/80 leading-relaxed">
                            I design and ship end-to-end solutions across web, cloud, and automation. With a strong product mindset
                            and a love for polished developer tools, I turn complex requirements into delightful experiences that
                            scale.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {focusAreas.map((area) => (
                                <Badge key={area} variant="outline" className="border-primary/30 bg-background/60 text-sm text-primary">
                                    {area}
                                </Badge>
                            ))}
                        </div>
                    ...
                    <div className="space-y-6 rounded-3xl border border-border/50 bg-background/70 p-8 shadow-xl backdrop-blur-xl">
                        <div className="space-y-2">
                            <p className="text-sm uppercase tracking-widest text-muted-foreground">Snapshot</p>
                            <h2 className="text-2xl font-semibold text-foreground">Building momentum with thoughtful engineering</h2>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                                Currently shaping energy tech and accessible tooling. I partner with founders and teams to create
                                products that balance performance, accessibility, and maintainability.
                            </p>
                        </div>
                        ...
                        <div className="rounded-2xl border border-dashed border-primary/30 bg-primary/5 p-5 text-sm text-muted-foreground">
                            Let's turn your roadmap into tangible outcomes — from discovery to deployment.
                        </div>
                    </div>
                </div>
            </div>
