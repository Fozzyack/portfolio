...
const toolGroups: ToolGroup[] = [
    {
        ...
        title: "Languages",
        description:
            "Core languages for product, systems, and performance work.",
        direction: "left",
        speedSeconds: 34,
        tools: [
            {
    ...
    },
    {
        ...
        title: "Frameworks",
        description:
            "Frontend and backend frameworks used to ship quickly and safely.",
        direction: "right",
        speedSeconds: 30,
        tools: [
            {
    ...
    },
    {
        ...
        title: "Data & Cloud",
        description:
            "Databases, infrastructure, and deployment services used in production.",
        direction: "left",
        speedSeconds: 36,
        tools: [
            {
    ...
    },
    {
        ...
        title: "Tooling",
        description:
            "Daily workflow stack for coding, review, testing, and delivery.",
        direction: "right",
        speedSeconds: 28,
        tools: [
            {
    ...
    return (
        ...
        >
            ...
            <ScrollReveal variant="scale" className="relative">
                <div className="mx-auto max-w-6xl border border-[#232720]/20 bg-[#e8e1d2] p-6 md:p-8">
                    <div className="border-b border-[#232720]/15 pb-6">
                        <div>
                            ...
                            <p className="mt-3 max-w-2xl text-[0.7rem] uppercase tracking-[0.14em] text-[#232720]/70">
                                A moving snapshot of the technologies I use most
                                across frontend interfaces, backend systems,
                                cloud deployment, and developer workflow.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 space-y-5">
                        {toolGroups.map((group, groupIndex) => (
                            <ScrollReveal
                                ...
                                threshold={0.05}
                            >
                                <section className="border border-[#232720]/15 bg-[#f1eee6] p-4">
                                    ...
                                    <div className="relative mt-3 overflow-hidden border border-[#232720]/10 bg-[#e5dece] px-2 py-2">
                                        ...
                                        <div
                                            ...
                                            style={{
                                                animationDuration: `${group.speedSeconds}s`,
                                            }}
                                        >
                                            {[
                                                ...group.tools,
                                                ...
                                                >
                                                    {tool.svg ? (
                                                        ...
                                                        <span className="flex h-6 w-6 items-center justify-center text-[0.56rem] uppercase tracking-[0.1em] text-[#232720]/40">
                                                            &lt;/&gt;
                                                        </span>
                                                    )}
