        ...
        >
            ...
            <div className="relative mx-auto max-w-6xl p-6 md:p-8">
                ...
                <div className="relative mt-8">
                    <ScrollReveal variant="in" threshold={0.05}>
                        <div className="pointer-events-none absolute bottom-0 left-[1.05rem] top-0 w-px origin-top bg-[#232720]/18 animate-draw-line md:left-1/2 md:-translate-x-1/2" />
                    </ScrollReveal>
                        ...
                        {experiences.map((item, index) => {
                            ...
                            return (
                                <ScrollReveal
                                    ...
                                    threshold={0.1}
                                >
                                    <article className="relative grid gap-3 pl-10 md:grid-cols-2 md:gap-10 md:pl-0">
                                        <span className="absolute left-[1.05rem] top-3 h-2.5 w-2.5 -translate-x-1/2 border border-[#232720]/40 bg-[#c8b28b] transition-transform duration-200 hover:scale-125 md:left-1/2" />
                                        ...
                                        <div
                                            className={`border border-[#232720]/15 bg-[#f1eee6] p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#232720]/30 hover:bg-[#ede8dc] md:row-start-1 ${
                                                isSecondSide
                                                    ? "md:col-start-1"
                                                    : "md:col-start-2"
                                            }`}
